...
output_dir='work_dirs/VG_R101_gref_umd_vl_deepFuseMlp_add00NoImgNoWord_sigmoid_query_0524/'
...
freeze_modules=['backbone', 'neck', 'bert']
...
model_config = dict(
    decoder=dict(
        ...
        num_layers=6,
        layer=dict(
            type='NewMultiStageDecoderLayer',
            d_model=256,
